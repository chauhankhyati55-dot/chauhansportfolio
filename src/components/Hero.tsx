          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              ...
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6 text-center mx-auto" variants={itemVariants}>
                Strategic Marketing Analyst at Netflix with 4+ years of experience in advanced analytics, omnichannel performance, and AI-driven insights that deliver measurable business outcomes.
              </motion.p>

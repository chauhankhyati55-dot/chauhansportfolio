  ...
  return <motion.div className="relative w-full" initial="hidden" animate="visible" variants={containerVariants}>
      <div className="banner-container bg-black relative overflow-hidden h-[50vh] sm:h-[60vh] md:h-[500px] lg:h-[550px] xl:h-[600px] w-full">
        <div className="absolute inset-0 bg-black w-full">
          <img 
            src={heroCover}
            alt="Professional business meeting with city skyline" 
        ...
        <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              ...
              <motion.h2 className="text-2xl md:text-3xl font-semibold text-gray-200 mt-2" variants={itemVariants}>Marketing &amp; Data Analyst | Campaign Analytics &amp; Reporting</motion.h2>
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6 text-center mx-auto" variants={itemVariants}>
                Business data analyst specializing in marketing analytics, customer segmentation, dashboarding, and campaign performance — turning data into clear, actionable recommendations through innovative storytelling.
              </motion.p>

      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            Strategic Marketing Analyst with 4+ years of experience in advanced analytics, omnichannel performance, and AI-driven insights. Ready to discuss how data can drive your business growth.
          </p>
        </div>
